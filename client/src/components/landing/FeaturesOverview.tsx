  ...
  const features = {
    ...
    mentors: [
      ...
      },
      {
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a4 4 0 118 0v4m-4 12v-2m0 0V9a2 2 0 012-2h2a2 2 0 012 2v3m-6 0a2 2 0 100 4v-4zm0 0a2 2 0 01-2-2V9a2 2 0 012-2h2a2 2 0 012 2v3" />
          </svg>
        ),
    ...
    <section id="features" className="py-24 bg-gray-50/50">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="flex justify-center mb-16">
          <div className="bg-white/80 backdrop-blur-xl rounded-xl p-1 border border-black/5 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features[activeTab as keyof typeof features].map((feature, index) => (
            <div
              key={index}
              className="bg-white/80 backdrop-blur-xl border border-black/5 rounded-2xl p-8 hover:shadow-lg hover:shadow-black/5 transition-all duration-300 transform hover:-translate-y-1 group"
            >
              <div className="flex items-start space-x-4 mb-6">
                <div className="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center text-gray-600 group-hover:bg-black group-hover:text-white transition-all duration-300">
                  {feature.icon}
                </div>
        ...
        <div className="text-center mt-20">
          <div className="bg-black rounded-2xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-gray-600 text-white px-8 py-4 rounded-lg font-medium hover:bg-white/10 hover:border-gray-400 transition-colors">
                Schedule Demo
              </button>
            </div>
          </div>

...
export type BulkUpdateStatusInput = z.infer<typeof applicationSchemas.update>; // Will be defined separately
export type ExportApplicationsQuery = z.infer<typeof applicationSchemas.list>; // Will be defined separately
